                                    ...
                                    <div class="card-body">
                                        ...
                                        <form:form action="login" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input name="email" class="form-control" id="inputEmailAddress" type="email" placeholder="Enter email address" autofocus="true"/>
                                            </div>
                                            <!-- Form Group (password)-->
                                            <div class="mb-3">
                                                <label class="small mb-1" for="password">Password</label>
                                                <input name="password" class="form-control" id="inputPassword" type="password"  placeholder="Enter password" autofocus="true"/>
                                            </div>
